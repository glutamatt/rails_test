...
class FichiersControllerTest < ActionController::TestCase
  ...
  test "should create fichier" do
    assert_difference('Fichier.count') do
      post :create, fichier: { hashtag: @fichier.hashtag, name: @fichier.name, size: @fichier.size, user_id: @fichier.user_id }
    end
  ...
  test "should update fichier" do
    put :update, id: @fichier, fichier: { hashtag: @fichier.hashtag, name: @fichier.name, size: @fichier.size, user_id: @fichier.user_id }
    assert_redirected_to fichier_path(assigns(:fichier))
  end
